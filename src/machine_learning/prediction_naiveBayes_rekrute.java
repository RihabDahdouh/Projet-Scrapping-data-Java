...
// Define the class
public class prediction_naiveBayes_rekrute {
  // Main method, entry point of the program
  public static void main(String[] args) throws Exception {

    // Load training data from ARFF file
    ConverterUtils.DataSource source1 = new ConverterUtils.DataSource("ScraperOutputRekrute_Training.arff");
    ...
    ConverterUtils.DataSource source2 = new ConverterUtils.DataSource("ScraperOutputRekrute_Testing.arff");
    ...
    System.out.println("La donnée appartient au secteur d'activité : " + instance.attribute(7).value((int) predictions));
  }
}
