...
public class Kmeans_mjob {
  public Kmeans_mjob() throws Exception {
    ...
    breader_test = new BufferedReader(new FileReader("ScraperOutputMJob_Testing.arff"));
    breader = new BufferedReader(new FileReader("ScraperOutputMJob_Training.arff"));
