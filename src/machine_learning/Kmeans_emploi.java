...
public class Kmeans_emploi {
  public Kmeans_emploi() throws Exception {
    ...
    breader_test = new BufferedReader(new FileReader("ScraperOutputEmploi_Testing.arff"));
    breader = new BufferedReader(new FileReader("ScraperOutputEmploi_Training.arff"));
