...
class prediction_j48_rekrute {
    ...
    public void J48Algo(Instances dataTrain, Instances dataTest) throws Exception {
        ...
        // Set Target Class
        // For training Data
        // Classify with activity sector as the target
    ...
    public void predict(Instance predict) throws Exception {
        ...
        System.out.println("La donnée appartient au secteur d'activité : " + predict.attribute(7).value((int) predictions));
    }

    // Main method to demonstrate the usage of the J48 algorithm for prediction
    public static void main(String[] args) throws Exception {
        // Create an instance of the prediction_j48_rekrute class
        prediction_j48_rekrute classif = new prediction_j48_rekrute();
