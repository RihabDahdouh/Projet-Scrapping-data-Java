...
class prediction_j48_mjob {
    ...
    public void J48Algo(Instances dataTrain, Instances dataTest) throws Exception {
        ...
        // Set Target Class
        // For training Data
        // Classify with experience as the target
    ...
    public void predict(Instance predict) throws Exception {
        ...
        System.out.println("La donnée appartient à l'expérience : " + predict.attribute(7).value((int) predictions));
    }

    // Main method to demonstrate the usage of the J48 algorithm for prediction
    public static void main(String[] args) throws Exception {
        // Create an instance of the prediction_j48_mjob class
        prediction_j48_mjob classif = new prediction_j48_mjob();

        // Load training and testing data from ARFF files
        Instances dataTrain = classif.getData("ScraperOutputMjob_Training.arff");
        Instances dataTest = classif.getData("ScraperOutputMjob_Testing.arff");
